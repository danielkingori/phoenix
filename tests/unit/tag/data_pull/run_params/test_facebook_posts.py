...
def test_create(
    ...
    """Test create of the facebook_posts data pull run params."""
    ...
    assert urls.for_tagging == f"{TAGGING_BASE}for_tagging/facebook_posts_for_tagging.parquet"

    assert urls.pulled == f"{TAGGING_BASE}facebook_posts_pulled.parquet"

    input_dataset = (
        "s3://data-lake/tenant_id_1/"
        "base/grouped_by_year_month/facebook_posts/year_filter=2021/month_filter=11/"
    )
