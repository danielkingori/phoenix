...
def test_create(
    ...
    """Test create of the youtube_videos data pull run params."""
    ...
    assert urls.for_tagging == f"{TAGGING_BASE}for_tagging/youtube_videos_for_tagging.parquet"

    assert urls.pulled == f"{TAGGING_BASE}youtube_videos_pulled.parquet"

    input_dataset = (
        "s3://data-lake/tenant_id_1/"
        "base/grouped_by_year_month/youtube_search_videos/year_filter=2021/month_filter=11/"
    )
