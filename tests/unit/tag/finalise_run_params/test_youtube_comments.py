...
def test_create(
    ...
    """Test create of the youtube_comments run params."""
    ...
    assert urls.input_dataset == f"{TAGGING_BASE}youtube_comments_pulled.parquet"
    ...
    assert urls.tagging_final == f"{TAGGING_BASE}youtube_comments_final.parquet"
    if expected_final_url == "default":
        FINAL_BASE = (
            "s3://data-lake/tenant_id_1/final/youtube_comments/youtube_comments_final.parquet"
        )
