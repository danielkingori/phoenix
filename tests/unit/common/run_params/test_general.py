...
@mock.patch("phoenix.common.config.tenant.get_config")
@mock.patch("phoenix.common.config.tenant.get_config_url")
...
def test_create(m_run_dt_str, m_run_dt_now, m_art_url_reg, m_tenant_config_url, m_tenant_config):
    ...
    m_tenant_config_url.assert_called_once_with(environment_key)
    m_tenant_config.assert_called_once_with(tenant_id, m_tenant_config_url.return_value)
...
@mock.patch("phoenix.common.run_datetime.create_run_datetime_now")
@mock.patch("phoenix.common.run_datetime.from_file_safe_str")
def test_create_none_run_dt(
    m_run_dt_str, m_run_dt_now, m_art_url_reg, m_tenant_config_url, m_tenant_config
):
