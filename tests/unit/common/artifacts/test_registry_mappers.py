...
def test_url_mapper(m_default_url_prefix, tenant_config):
    """Test source urls."""
    ...
    r_url = registry_mappers.url_mapper(
        format_str, artifact_key, url_config, environment_key, tenant_config
    )
...
@mock.patch("phoenix.common.artifacts.registry_environment.default_url_prefix")
def test_url_mapper_url_config_key_not_found(m_default_url_prefix, tenant_config):
    """Test source urls."""
    artifact_key: registry_mappers.ArtifactKey = "source-posts"
