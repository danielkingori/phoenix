"""Data Pull run params for facebook posts."""
...
def get_urls(
    ...
    """Get DataPullRunParamsURLs for facebook_posts."""
    ...
    return dtypes.DataPullRunParamsURLs(
        config=url_config,
        input_dataset=art_url_reg.get_url("tagging_runs-facebook_posts_input", url_config),
        pulled=art_url_reg.get_url("tagging_runs-facebook_posts_pulled", url_config),
