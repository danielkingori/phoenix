"""Kiswahili NLP.
Stemmer has been copied from https://github.com/ondieki/swahili/blob/master/Stemmer.py,
which can't be installed as a package as it doesn't have a setup.py
An algorithm for SWAHILI prefix and suffix stripping, providing you with the core componets of a word in Swahili,
giving you the stem of the word
"""
...
class Stemmer:
    ...
    def cons(self, i):
        ...
        if self.b[i] == 'a' or self.b[i] == 'e' or self.b[i] == 'i' or self.b[i] == 'o' or self.b[
            i] == 'u':
            return 0
        return 1
    ...
    def step2(self):
        ...
        p2 = re.compile(
            '(ni|u|a|tu|m|wa|i|li|ya|ki|vi|zi|ku|pa)(me|li|ta|na)?(ni|tu|ku|mu|wa|cho)?[a-z]{2}')
        ...
        self.RESULT[self.KEY].append(
            phrase)  # store result as a list whose key is the original word in sentence
