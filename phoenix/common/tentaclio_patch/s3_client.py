"""S3Client that has the upload_extra_args."""
from typing import Dict, Generator, Iterable, Optional, Tuple, Union, cast

import boto3
from botocore import client as boto_client
from tentaclio import base_client, decorators, exceptions, fs, protocols, urls
...
class S3Client(base_client.BaseClient["S3Client"]):
    ...
    def __init__(
        ...
        upload_extra_args: Optional[Dict] = None,
    ) -> None:
    ...
    def close(self) -> None:
        ...
        if self.closed:  # type: ignore[has-type]
    ...
    def put(
        ...
        extra_args = self.upload_extra_args
